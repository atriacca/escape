...
if (do1 == 1) {
    ...
    if (do2 == 1) {
        ...
        onsole.log(`Hmmmm... Sorry, ${name}, but you selected to find the key that you've already found. Please try again and be sure.`)
    } else if (do2 == 3) {
        console.log(`Yay! You win, ${name}! Your character just opened the locked door with the key. Please see Eric for your prize!`)
    } else {
        console.log(`Hmmmm... Sorry, ${name}, but you submitted an unexpected entry. Please try again and be sure to only enter a 1, 2 or 3!`)
    }
} else if (do1 == 3) {
    console.log(`Sorry, ${name}, your character just tried to open the locked door without the key. Please try again!`)
} else {
    console.log(`Sorry, ${name}, your entry wasn't recognized. Please try again and be sure to only enter a 1, 2 or 3!`)
}/*
        console.log(`Yay! You win, ${name}! Your character just opened the locked door with the key. Please see Eric for your prize!`)
        } else if (do2 == 2) {
